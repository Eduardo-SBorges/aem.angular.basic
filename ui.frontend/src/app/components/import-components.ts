 ...
 */
MapTo('angularapp/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('angularapp/components/separator')(SeparatorV1Component);

MapTo('angularapp/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('angularapp/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('angularapp/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('angularapp/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('angularapp/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('angularapp/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('angularapp/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('angularapp/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('angularapp/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});
